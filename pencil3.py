...
if uploaded_file is not None:
    ...
    # Step 4: Convert the pencil sketch (PNG) to SVG using vtracer
    ...
    st.download_button(label="Download SVG", data=svg_sketch_str, file_name="pencil_sketch.svg", mime="image/svg+xml")
